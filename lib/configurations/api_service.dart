...
import '../module/common_widgets/common_widget.dart';
import '../module/utility/color_utility.dart';
...
apiServiceCall({
  ...
  if (await checkInternet()) {
    ...
    Map<String, dynamic> headerParameters = {
      'Authorization': 'Basic TmlrdW5qX0dhamVyYTpuaWt1bmoyNzEx'
    };
    // if (headerToken == "") {
    //   headerParameters = {
...
linkWiseAPICall(String url) async {
  try {
    ...
    if (response.statusCode == 200) {
      ...
      return '${responseData.value} ${responseData.unitsAbbreviation}';
    } else {
      BooleanResponseModel? responseData;
      responseData = BooleanResponseModel.fromJson(
          response.data
